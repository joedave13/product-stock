...
<?php 
    include '../koneksi.php';
    $result = mysqli_query($koneksi, "SELECT MAX(kode_pengeluaran) AS kode FROM pengeluaran");
    ...
    $newKode = "KLR-" . sprintf("%05s", $urutan);
?>

<div class="container mt-3">
    <div class="card">
        <div class="card-header">
            <h4>Tambah Transaksi Pengeluaran</h4>
        </div>
        <div class="card-body">
            <form action="pengeluaran_tambah_act.php" method="post">
